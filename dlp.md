...
### [サービスエージェントへデータプロファイリングのアクセス権を付与する](https://cloud.google.com/dlp/docs/grant-data-profiling-access)
...
### [概要](https://cloud.google.com/dlp/docs/concepts-deidentify-storage)
